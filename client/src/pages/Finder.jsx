    ...
    <main>
      ...
      <div className="relative px-16 bg-[#D7DEDC] overflow-hidden">
        ...
        <img
          ...
          alt="hero"
          className="clip-path w-60 absolute z-0 top-0 right-40 h-full object-cover"
        />

        <img
          src="/team.jpg"
          alt="hero"
          className="clip-path-2 rotate-6 w-60 absolute z-0 top-0 right-128 h-full object-cover"
        />
      </div>
