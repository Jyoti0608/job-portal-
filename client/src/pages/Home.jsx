...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="py-20 bg-linear-to-b from-[#d7dedc] to-[#7263f3]/5 text-primary-foreground">
      ...
      <section className="py-20 bg-[#f0f5fa]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose{" "}
            <span className="text-[#7263f3] font-extrabold">
              JobStart
            </span>
          </h2>
